...
public:
  ...
  virtual void do_memory_allocate_node(xpl::memory_allocate_node *const node, int lvl) = 0;
  virtual void do_memory_address_node(xpl::memory_address_node *const node, int lvl) = 0;
